...
Package Tracker and (Badge) Frontage for GitHub Packages

</div>

---

The Packages API doesn't provide much metadata; this project aims to fill that gap. If you're here to make a badge, use something like [shields.io/json](https://shields.io/badges/dynamic-json-badge) with the endpoint. Here's what badges could look like for some of the available parameters:
...
Imagine an ever-growing lawn increasingly covered less than π/2 rad at a time. All of it can be found under the [latest release](https://github.com/ipitio/backage/releases/latest).
