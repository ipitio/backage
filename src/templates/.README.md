...
uses an authenticated GitHub CLI to create a personal fork, enable the workflows
GitHub disables on new forks, and dispatch its initial Build. It is safe to run
again: existing deployment branches and intentionally disabled workflows are
left alone.
