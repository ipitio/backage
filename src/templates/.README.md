...
```markdown
https://raw.githubusercontent.com/<GITHUB_OWNER>/<GITHUB_REPO>/<GITHUB_BRANCH>/index/<OWNER>/<REPO>/<PACKAGE>.json
```
...
Imagine an ever-growing lawn increasingly covered less than π/2 rad at a time. It can be found under the [latest release](https://github.com/ipitio/<GITHUB_REPO>/releases/latest).
