...
```py
https://<GITHUB_OWNER>.github.io/<GITHUB_REPO>?json=https://URLENCODED/JSON/PATH
```

Use your own JSON endpoint with this proxy to convert it into XML. Try it out in your browser:

##### [https://<GITHUB_OWNER>.github.io/<GITHUB_REPO>?json=https://<GITHUB_OWNER>.github.io/<GITHUB_REPO>/<GITHUB_OWNER>/<GITHUB_REPO>/<GITHUB_REPO>.json](https://<GITHUB_OWNER>.github.io/<GITHUB_REPO>?json=https://<GITHUB_OWNER>.github.io/<GITHUB_REPO>/<GITHUB_OWNER>/<GITHUB_REPO>/<GITHUB_REPO>.json)
