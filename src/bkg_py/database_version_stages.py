...
from .database_models import VersionStage
from .database_support import DatabaseError
from .database_values import legacy_version_values, normalized_version_values
...
def flush(
    ...
    with _transaction(connection):
        ...
        if publication_pending_at is not None:
            database_packages.mark_publication_pending(
                connection,
                stage.package_ref,
